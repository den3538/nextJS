            ...
            <Card className="w-full max-w-md mx-auto border-gray-200 shadow-lg">
                <CardHeader className="space-y-1">
                    ...
                    <CardDescription className="text-gray-600">
                        Sign in to your account to continue tracking your job applications and managing your career journey effectively.
                    </CardDescription>
                </CardHeader>
                <form className="space-y-4">
                    ...
                    <CardFooter className="flex flex-col space-y-4">
                        ...
                        <p className="gap-x-10">Don&apos;t have an account? <Link href="/sign-up" className="underline">Sign Up</Link></p>
                    </CardFooter>
                </form>
            </Card>
        </div>
